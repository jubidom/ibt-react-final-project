...
//             <FaShoppingBag style={{ marginRight: "0.5rem" }} /> Products
//           </NavLink>
//           <NavLink to="/contact" onClick={onClose}>
//             <FaPhone style={{ marginRight: "0.5rem" }} /> Contact Us
//           </NavLink>
//           <NavLink to="/about" onClick={onClose}>
//             <FaInfoCircle style={{ marginRight: "0.5rem" }} /> About Us
//           </NavLink>
//           <NavLink to="/blog" onClick={onClose}>
//             <FaPen style={{ marginRight: "0.5rem" }} /> Blog
//           </NavLink>
//         </nav>
...
//         {/* Bottom actions (always visible) */}
//         <div className={styles.bottomSection}>
//           <button onClick={onLogin} className={styles.account}>
//             <FaUser style={{ marginRight: "0.5rem" }} /> Login
//           </button>
//           <button onClick={onToggleTheme} className={styles.themeToggle}>
//             {theme === "dark" ? <><FaMoon style={{ marginRight: "0.5rem" }} /> Dark</> 
//                                : <><FaSun style={{ marginRight: "0.5rem" }} /> Light</>}
//           </button>
//         </div>
//       </div>
//     </>
